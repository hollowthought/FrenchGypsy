...
def _add_thumb(s):
	...
	'.thumb' before the file extention ( which is changed to be '.jpg' ).
	'''
	parts = s.split(".")
	parts.insert(-1, "thumb")
	if parts[-1].lower() not in ['jpg' , 'jpg']:
		parts[-1] = 'jpg'
	return ".".join(parts)
...
class ThumbnailImageField(ImageField):
    '''
    Behaves like a regular ImageField, but stores and extra (JPEG) thumbnail
    ...
    staying inside the requested dimentions; see PIL's Image.thumbnail()
    method for documentation details.
    '''
